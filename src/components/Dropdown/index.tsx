...
const Dropdown: FC<DropdownProps> = ({ className, options, placeholder, onSelect }) => {
  ...
  return (
    <select className={classNames("dropdown-component", className)} onChange={(e) => handleSelect(e.target.value)}>
