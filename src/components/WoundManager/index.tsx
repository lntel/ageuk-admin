    ...
    <div className="wound-manager__wound">
      ...
      <div className="wound-manager__wound__inputs">
        <Textbox
          ...
          value={type}
        />
        <Textbox className="wound-manager__wound__input" placeholder="Length" value={String(measurements.length)} />
        <Textbox className="wound-manager__wound__input" placeholder="Width" value={String(measurements.width)} />
        <Textbox className="wound-manager__wound__input" placeholder="Depth" value={String(measurements.depth)} />
      </div>
    </div>
  );
};
...
const WoundManager: FC<WoundManagerProps> = ({ isOpen }) => {
  ...
  return (
    ...
    >
      ...
      <div className="wound-manager__wounds">
        {wounds.length
          ? wounds.map((wound) => (
              <WoundCard key={wound.type} location={wound.location} type={wound.type} measurements={wound.measurements} />
            ))
          : null}
      </div>
    </ReactModal>
